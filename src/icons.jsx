...
export const ACH_ICONS = {
  ...
  jackpot: (
    ...
    >
      <polygon
        points="10,2 12.5,7.5 18,8.2 14,12 15.1,17.5 10,14.8 4.9,17.5 6,12 2,8.2 7.5,7.5"
        fill="currentColor"
        fillOpacity="0.3"
      />
    </svg>
  ...
  lucky7: (
    ...
    >
      <rect x="3" y="3" width="14" height="14" rx="3" />
      <path d="M7 7h6l-4 9" strokeLinejoin="round" />
    </svg>
  ),
  crash_5x: (
    <svg
  ...
  bj_natural: (
    ...
    >
      ...
      <rect x="9" y="5" width="8" height="12" rx="1.5" />
      <path d="M6 8h2M6 11h3" />
    </svg>
  ),
  bj_double: (
    <svg
  ...
  streak_5: (
    ...
    >
      <path
        d="M10 17C7 17 5 14 5 11c0-3 2-5 3-6 0 2 1 3 2 3 0-3 2-5 3-6 1 3 3 5 3 9 0 3-2 6-6 6z"
        fill="currentColor"
        fillOpacity="0.2"
      />
    </svg>
  ...
  streak_10: (
    ...
    >
      <path
        d="M10 2l1.5 4h4l-3.3 2.4 1.3 4L10 14l-3.5 2.4 1.3-4L4.5 6h4z"
        fill="currentColor"
        fillOpacity="0.3"
      />
    </svg>
  ...
  war_won: (
    <svg
      ...
      strokeLinecap="round"
    >
      <path d="M4 16L14 6M14 6l2-2M4 16l-1 1" />
      <rect
        x="8.5"
        y="9.5"
        width="3"
  ...
  millionaire: (
    ...
    >
      <circle cx="10" cy="10" r="7" />
      <path d="M10 7v.8M10 12.2V13" />
      <path d="M8.2 9c0-.9.8-1.6 1.8-1.6s1.8.7 1.8 1.6c0 .6-.4 1-1.8 1.2-1.4.2-1.8.6-1.8 1.2 0 .9.8 1.6 1.8 1.6s1.8-.7 1.8-1.6" />
    </svg>
  ),
  comeback: (
    <svg
  ...
  vip_gold: (
    ...
    >
      <path
        d="M3 14l3-6 4 4 4-4 3 6H3z"
        fill="currentColor"
        fillOpacity="0.2"
      />
      <path d="M2 7l4 4 4-5 4 5 4-4" />
    </svg>
  ),
  vip_diamond: (
    <svg
      ...
      strokeLinecap="round"
    >
      <path d="M10 2l8 6-8 10L2 8z" fill="currentColor" fillOpacity="0.2" />
